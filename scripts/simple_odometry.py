...
class SimpleOdometry(Node):
    def __init__(self):
        ...
        self.declare_parameter('wheel_separation', 0.115)  # 115mm actual wheel separation
        self.declare_parameter('wheel_radius', 0.025)     # 25mm radius (50mm diameter)
    ...
    def encoder_callback(self, msg):
        ...
        if self.first_reading:
            ...
            self.last_left_enc = msg.mot_2_enc_val   # Left motor is mot_2
            self.last_right_enc = msg.mot_1_enc_val  # Right motor is mot_1
            self.last_time = current_time
            self.first_reading = False
            return
        
        # Calculate encoder differences
        left_diff = msg.mot_2_enc_val - self.last_left_enc
        right_diff = msg.mot_1_enc_val - self.last_right_enc
        ...
        self.last_left_enc = msg.mot_2_enc_val
        self.last_right_enc = msg.mot_1_enc_val
        self.last_time = current_time
