...
This laun    # LiDAR Launch - Starts the LD19 LiDAR driver (official integration)
    # Note: This will create ldlidar_state_publisher for ldlidar_base → ldlidar_link transform
